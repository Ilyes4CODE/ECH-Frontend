let allDettes = [];
        ...
        async function loadDettes() {
            try {
                showLoading();
                const response = await fetch(`https://backend.echsahra.com/gestion/dettes/`, {
                    headers: {
        ...
        async function generatePDF(detteId) {
            try {
                const response = await fetch(`https://backend.echsahra.com/gestion/dettes/${detteId}/`, {
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('access_token')}`
                    }
                });
                ...
                if (response.ok) {
                    ...
                    const pdfResponse = await fetch(`https://backend.echsahra.com/gestion/dettes/${detteId}/journal/pdf/`, {
                        method: 'GET',
                        headers: {
                            'Authorization': `Bearer ${localStorage.getItem('access_token')}`
                        }
        ...
        async function handleAddDette(e) {
            ...
            try {
                const response = await fetch(`https://backend.echsahra.com/gestion/dettes/create/`, {
                    method: 'POST',
                    headers: {
        ...
        async function handlePayment(e) {
            ...
            try {
                const response = await fetch(`https://backend.echsahra.com/gestion/dettes/${detteId}/payment/`, {
                    method: 'POST',
                    headers: {
                        'Authorization': `Bearer ${localStorage.getItem('access_token')}`
                    },
